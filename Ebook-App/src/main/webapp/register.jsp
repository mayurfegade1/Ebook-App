...
<body style="background-color: #7d2ae8;">
	...
	<button  class="btn" onclick="window.location.href='index.jsp';"><i class="fa fa-home"></i> Home</button>
		...
		<div class="forms">
				...
				<div class="signup-form">
					...
					<c:if test="${not empty succMsg }">
						...
						<div class="input-boxes">
							...
							<div class="input-box">
								<i class="fas fa-envelope"></i> <input type="text"
									placeholder="Enter your mobile no" required="required" name="mono">
							</div>
							<div class="input-box">
							...
							<div class="button input-box">
								<input  name="btnsub" type="submit" value="Register"  for="flip">
							</div>
			...
			<button  class="btn" onclick="window.location.href='index.jsp';"><i class="fa fa-home"></i> Home</button>
					<div class="title" padding-top=50px>Login</div>
					<c:if test="${not empty failedMsg }">
