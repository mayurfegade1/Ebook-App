			...
			<div class="col md-6 text-center p-5 border bg-white">
				...
				<%
					if("Old".equals(b.getBookCategory())){
						...
						<h5 class="text-primary ml-1"><i class="fa-solid fa-envelope"></i>  EMail: <%=b.getEmail() %></h5>
...
<%if("Old".equals(b.getBookCategory())) {
	%>
				...
				<a href="index.jsp" class="btn btn-success"><i class="fa-solid fa-cart-shopping fa-beat-fade"></i>continue shopping</a>
...
<% }else{%>
				...
				<div class="text-center p-3">
				<a href="" class="btn btn-primary"><i class="fa-solid fa-cart-shopping fa-beat-fade"></i>Add Cart</a>
				<a href="" class="btn btn-danger"><i class="fa-solid fa-indian-rupee-sign"></i>200</a>
